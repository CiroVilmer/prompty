  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="staggered-menu-pill w-full mx-4 mt-4 flex items-center justify-between rounded-full border border-gray-200 bg-white/90 px-5 py-3 shadow-lg shadow-black/5 backdrop-blur-sm pointer-events-auto">
          <a href="/" className="sm-logo flex items-center select-none" aria-label="Go to homepage">
            <img
        ...
        >
          ...
          <div className="mt-auto pt-6">
            <a
              href="https://github.com/CiroVilmer/prompty"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="View on GitHub"
              className="inline-flex items-center gap-2 text-gray-400 transition-colors hover:text-gray-900"
            >
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: flex-start; justify-content: center; padding: 0; background: transparent; pointer-events: none; z-index: 20; }
.sm-scope .staggered-menu-pill { display: flex; align-items: center; justify-content: space-between; margin: 1rem; flex: 1; border-radius: 9999px; border: 1px solid #e5e7eb; background: rgba(255,255,255,0.9); padding: 0.6rem 1.25rem; box-shadow: 0 4px 24px -4px rgba(0,0,0,0.08); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); pointer-events: auto; }
...
@media (max-width: 640px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } .sm-scope .sm-panel-item { font-size: clamp(1.6rem, 8.5vw, 3.5rem); letter-spacing: -0.5px; } .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { right: 1.5em; font-size: 11px; } }
      `}</style>
    </div>
  );
};
