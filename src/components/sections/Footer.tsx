...
const SOCIAL_LINKS = [
  ...
  { label: 'GitHub',      href: 'https://github.com/prompty',           Icon: IconGitHub    },
  { label: 'Instagram',   href: 'https://instagram.com/prompty',        Icon: IconInstagram },
]
    ...
    <footer className="border-t border-gray-200 bg-white">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="flex flex-col items-center gap-4 py-6 md:flex-row md:justify-between">
          <span className="text-sm text-gray-400">© 2025 Prompty</span>
